...
\begin{solution}
  \begin{enumerate*}
    \item $M = \SI{71}{g/mol}$; \item $M = \SI{58}{g/mol}$; \item $M = \SI{44}{g/mol}$.
    \end{enumerate*}
\end{solution}
...
\end{exercise}
\begin{solution}
  \begin{enumerate*} % REVIEW no sé como reacciona la siguiente línea
    \item $m_\ch{H2S} = \SI{102}{\gram}$; \item \SI{1.8e24}{moléculas}; \item \SI{3}{moles} de \ch{H2} y \SI{3}{moles} de \ch{S}.
  \end{enumerate*}
\end{solution}
