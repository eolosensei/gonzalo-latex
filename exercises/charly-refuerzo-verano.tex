...
\begin{exercise}
  23. Un compuesto orgánico tiene la siguiente composición centesimal: $\ch{C} = 24,24\%$, $\textrm{H} = 4,05\%$, $\textrm{Cl} = 71,71\%.$ Calcula: % REVIEW revisar como reacciona el chemformula aquí
  \begin{enumerate}
