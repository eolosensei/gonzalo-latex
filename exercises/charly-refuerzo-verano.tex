...
\begin{exercise}[
  ...
  (13) ¿Cuál será el volumen de \ch{HCl}, medido en CN, que podremos
...
\begin{exercise}[
  ...
  (18) En un matraz de \SI{5}{\liter} hay \SI{42}{\gram} de \ch{N2} a \SI{27}{\celsius}. Se abre el recipiente hasta que su presión se iguala con la presión atmosférica, que es de \SI{1}{atm}.
  \begin{enumerate}
...
\begin{exercise}[
  ...
  (21) En CNTP, \SI{1}{mol} de \ch{NH3} ocupa \SI{22.4}{\liter} y contiene \SI{6.02e23}{moléculas}. Calcula:
  \begin{enumerate}
...
\begin{exercise}[
  ...
  (28) Escribe y nombra todos los isómeros estructurales de fórmula \ch{C5H10}
\end{exercise}
