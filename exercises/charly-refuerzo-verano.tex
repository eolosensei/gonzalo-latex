...
% Datos: \Delta H^0_f (kJ/mol): KClO3 _{(s)} = -91,2; KCl _{(s)} = -436
...
% de propano de 1,80 litros a \SI{25}{\celsius} y 4 atm de presión.
% S: a) \Delta H^0_c = -2,22 · 10^3 kJ/mol de propano; b) Se desprenden
% 156 kcal
%
...
% S: a) \Delta H^0_f (CuO) = -146 kJ/mol;
...
% S: a) \Delta H^0_c etanol = -1,37·10^3 kJ/mol; \Delta H^0_c ácido etanoico = -870 kJ/mol
% b) \Delta H^0_f etanol = -273 kJ/mol; \Delta H^0_f ácido etanoico = -489 kJ/mol
%
% 24> Calcula la entalpía de la reacción:
% CH4 _{(g)} + Cl2 _{(g)} ➔ CH3Cl _{(g)} + HCl _{(g)} a partir de:
...
% (CH4) = -74,9; (CH3Cl) = -82,0; \Delta H^0_f (HCl) = -92,3.
% S: a) \Delta H^0_R = -102 kJ; b) \Delta H^0_R = -99,4 kJ
%
% 25> El eteno se hidrogena para dar etano, según:
% CH2=CH2 _{(g)} + H2 _{(g)} ➔ CH3-CH3 _{(g)} \Delta H^0_R = -130 kJ
% Calcula la energía del enlace C=C, si las energías de los
% enlaces C-C, H-H y C-H son, respectivamente, 347, 436
% y 414 kJ/mol. S: \Delta H^0 (C=C) = 609 kJ/mol
%
% 26> A partir de los siguientes datos:
% Entalpía estándar de sublimación del C _{(s)} = 717 kJ/mol.
% Entalpía de formación del CH3-CH3 _{(g)} = -85,0 kJ/mol.
...
% 2C (g) + 3H2 _{(s)} ➔ CH3-CH3 _{(g)} e indica si es exotérmica
% o endotérmica.
% b) Determina el valor medio del enlace C-H.
% S: a) \Delta H^0_R = -1,52·10^3 kJ; b) \Delta H^0 (C-H) = 413 kJ/mol
%
%
...
% CS2 _{(l)} + 3 O2_{(g)} -> CO2 _{(g)} + 2 SO2 _{(g)} \Delta H_R = -1072 kJ
% a) Calcula la entalpía de formación del CS2
% b) Halla el volumen de SO2 emitido a la atmósfera, a \SI{1}{atm} y
% 25 °C, cuando se ha liberado una energía de 6000 kJ
% Datos: \Delta H^0_f (kJ/mol): CO2_{(g)} = -393,5; SO2_{(g)} = -296,4.
% S: a) \Delta H^0_f CS2_{(l)} = 85,7 kJ/mol; b) V = 274 L (SO2)
%
% 5. El dióxido de manganeso se reduce a manganeso metal reaccionando
% con el aluminio según:
% MnO2 _{(s)} + Al _{(s)} --> Al2O3 _{(s)} + Mn _{(s)}
% a) Halla la entalpía de esa reacción sabiendo que las entalpías
% de formación valen:
% \Delta H^0_f (Al2O3) = -1676 kJ/mol; \Delta H^0_f (MnO2) = -520 kJ/mol
% b) ¿Qué energía se transfiere cuando reaccionan 10,0 g de
% MnO2 con 10,0 g de Al?
% S: a) \Delta H_R = -896 kJ/mol de Al2O3 ; b) 68,7 kJ se desprenden
%
% 6. Durante la fotosíntesis, las plantas verdes sintetizan la glucosa
% según la siguiente reacción:
% 6 CO2_{(g)} + 6 H2O_{(l)} --> C6H12O6 _{(s)} + 6 O2_{(g)} \Delta H_R = 2815 kJ/mol
...
% Datos : \Delta H^0_f (kJ/mol): H2O_{(l)} = -285,8; CO2_{(g)} = -393,5
% S: a) \Delta H^0_f = -1,26·10^3 kJ/mol; b) 782 kJ; e) 0,8 L
%
% Las entalpías de combustión del etano y del eteno son
% -1560 kJ/mol y -1410 kJ/ mol respectivamente. Determina:
% a) El valor de \Delta H^0_f para el etano y el eteno.
...
% 50,0 g de cada gas.
% Datos: \Delta H^0_f (kJ/mol) : CO2_{(g)} = -393,5; H2O_{(l)} = -285,9
% S: a) \Delta H^0_f (C2H6)= -84,7 kJ/mol; \Delta H^0_f (C2H4 = 51,2 kJ/mol; b) Exotérmico; e) etano: 2,60·10^3 kJ; eteno: 2,52 • 10^3 kJ.
%
...
% Datos: \Delta H^0_f (kJ/mol): CO2_{(g)} = -394; H2O_{(l)} = -286; C8H18 _{(l)} = -250
...
% benceno líquido.
% c) Calcula el volumen de oxígeno, medido a \SI{25}{\celsius} y 5 atm,
% necesario para quemar 1 L de benceno líquido.
% d) Calcula el calor necesario para evaporar 10 L de benceno
% líquido.
% Datos: \Delta H^0_f (kJ/mol): C6H6 _{(l)}= +49; C6H6 (v)= +83;
% H2O_{(l)}= -286; CO2 _{(g)}= -393;
% Densidad benceno(l) = 0,879 g cm^-3
% S: b) \Delta H^0_C = -3,27·10^3 kJ/mol; e) 413 L; d) 3,83·10^3 kJ
%
%
%
%
...
% Datos: \Delta H^0_f (kJ/mol): CO2_{(g)}= -393,8; C8H18 _{(l)}= -264,0;
% H2O_{(l)}= -285,8
% S: a) \Delta H^0_C = -5,46·10^3 kJ/mol; b) 9,58·10^4 kJ
%
...
% \Delta H^0_f (kJ/mol): etino = 227; etano = -85,0
% S: a) \Delta H_R = -313 kJ/mol; b) \Delta H_R = -312 kJ/mol
%
%
%
%
...
% 2 H2O2 _{(l)} --> 2 H2O_{(l)} + O2_{(g)} \Delta H = -196 kJ
% N2 _{(g)} + 3 H2_{(g)} --> 2 NH3 _{(g)} \Delta H = -92,4 kJ
...
%
% 21. Dada la reacción: N2O_{(g)} --> N2_{(g)} + 1/2 O2 _{(g)}
% siendo \Delta H^0 = 43,0 kJ/mol y dS^0 = 80,0 J/mol K
% a) Justifica el signo positivo de la variación de entropía.
% b) ¿Será espontánea a \SI{25}{\celsius}? ¿A qué temperatura estará en
% equilibrio?
% S: a) Aumentan los moles de sustancias gaseosas b) \Delta G^0_R = 19,2 kJ (no es espontánea); T = 538 K
%
% 23. Se pretende obtener etileno (eteno) a partir de grafito e
% hidrógeno, a \SI{25}{\celsius} y \SI{1}{atm}, según la reacción:
% \ch{2 C_{(s)} + 2 H2_{(g)} --> C2H4 _{(g)}}. Calcula:
...
% Datos: S^0 (J mol-1 K-1): C_{(s)} = 5, 70; H2_{(g)} = 130,6;
% C2H4_{(g)}= 219,2 \Delta H^0_f (kJ/mol) : C2H4 _{(g)} = +52,5
% S: a) \Delta H^0_R = +52,5 kJ (endotérmica)
% b) \Delta G^0_R = +68,4 kJ (no es espontánea)
%
%
%
%
...
%
%
% El acetileno o etino (C2HJ se hidrogena para producir etano. Calcula a 298 K:
...
%
% Sustancia & \Delta H^0_f (kJ mol^-1) & \Delta G^0_f (kJ mol^-1) & S^0 (kJ mol^-1 K^-1) \\
% C2H2 & 227 & 209 & 200 \\
% C2H6 & -85 & -33 & 230 \\
%
% S: a) \Delta H^0_R = -312 kJ; b) \Delta G^0_R = -242 kJ; c) dS^0_R = -235 J/K d) S^0_H2, = 132 J/mol K
